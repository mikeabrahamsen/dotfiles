...
vicious.register(widgetVol, vicious.widgets.volume,  
    function (widget, args)
        ...
        else iconVol:set_image(beautiful.widget_vol_no) 
        end
        return  ' ' .. args[1] .. '%'
    end, 1, "Master")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Mod1"   }, "q",     function () awful.tag.incnmaster( 1)      end),
    awful.key({ modkey, "Mod1"   }, ";",     function () awful.tag.incnmaster(-1)      end),
